...
export default ({ app }: { app: express.Application }) => {
  ...
  app.post("/assertion/options", async (req, res) => {
    ...
    var url = `https://${isHost}/oauth2/authorize?scope=openid&response_type=code&redirect_uri=http://localhost
    .com:8080/pickup-dispatch/oauth2client&client_id=${client_id}`;
